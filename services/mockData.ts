...
export const mockSacraments: SacramentRecord[] = [
  ...
  { 
    ...
    // For list display compatibility, we can leave personName undefined and handle it in UI
    groomName: 'Luis Rojas',
    brideName: 'Ana Silva',
    groomFather: 'Mario Rojas',
    groomMother: 'Clara Díaz',
    brideFather: 'Juan Silva',
    brideMother: 'Rosa Méndez',
    date: '2024-05-20', 
  ...
  { 
    ...
    fatherName: 'Miguel Rodríguez',
    motherName: 'Carmen Soto',
    date: '2024-05-22', 
  ...
  { 
    ...
    book: '89', 
    page: '45',
    fatherName: 'José Díaz',
    motherName: 'Ana López',
    cemetery: 'Cementerio General',
    causeOfDeath: 'Causas naturales',
  ...
  { 
    ...
    fatherName: 'Andrés Silva',
    motherName: 'Patricia Ores',
    date: '2024-06-01', 
    celebrant: 'Pbro. Miguel Ángel', 
    book: '104', 
    page: '24',
